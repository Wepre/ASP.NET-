<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ReserveMark.aspx.cs" Inherits="HotelManage.ReserveMark" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>	预约信息（信息查询）/预约管理（入住管理）</title>
        <style type="text/css">
...
#research{ height:238px; 
background-color:White; width:100%;border-radius:15px 15px 0px 0px; font-size:15px; color:#343434;-webkit-box-shadow:#fff 0px 0px 10px;-moz-box-shadow:#666 0px 0px 10px
            }
.bt{ width:170px; height:22px}
.button{ border-style: none;border-color: inherit;border-width: 0px;background: #00AA68;border-radius:5px;; width:90px; font-family:微软雅黑; color:White; font-size:18px;cursor:pointer;  }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphRight" runat="server">
    ...
    <div id="research">
        ...
        &nbsp;&nbsp;
        房间编号：<asp:TextBox ID="txtRoomId" runat="server" CssClass="bt"></asp:TextBox>
        <br /><br />
        ...
        身份证号：<asp:TextBox ID="txtPid" runat="server" CssClass="bt"></asp:TextBox>
             &nbsp;&nbsp; &nbsp;&nbsp;<asp:Button ID="btnSearch" runat="server" Text="查询" CssClass="button" 
                onclick="btnSearch_Click" Width="98px"/>
        <br /><br />
        手机号码：<asp:TextBox ID="txtMobile" runat="server" CssClass="bt"></asp:TextBox>
        &nbsp;&nbsp; 
        入住时间：<asp:TextBox ID="txtInTime" runat="server" CssClass="bt"></asp:TextBox>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="删除记录" ShowHeader="False" Visible="false">
                    <ItemTemplate>
                        ...
                        <a onclick="JavaScript:return confirm('确定删除吗？')"><asp:Button ID="btnDel" runat="server" Text="删除" CommandName="sc" CommandArgument='<%#Eval("yid")%>' CssClass="button1"/></a>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
